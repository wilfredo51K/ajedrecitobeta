...
var demo = lemonCount;
if(detener==false){
setInterval(function(){ updateProgress(demo), demo = (demo >= 100 ? 38.4 : demo + 16.7) }, 700);
}
...
function selecciono(e){
    ...
    if(filap==filastar && columnap==columnastar){
        ...
        //abrir el enlace
        setTimeout(function() {location.href = "e3.html"}, 8000);
...
var paridad1=(columnastar+filastar)%2;
var paridad2=(columnap+filap)%2;
...
if(columnastar==columnap && filap==filastar){
    if(filastar-2>=0){
        filastar-=2;
    }else{
        if(columastar-2>=0){
