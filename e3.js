...
var demo = lemonCount;
if(detener==false){
setInterval(function(){ updateProgress(demo), demo = (demo >= 100 ? 42.6 : demo + 16.7) }, 700);
}
...
function selecciono(e){
    ...
    if(filap==filastar && columnap==columnastar){
        ...
        //abrir el enlace
        setTimeout(function() {location.href = "e4.html"}, 8000);
