...
var demo = lemonCount;
if(detener==false){
setInterval(function(){ updateProgress(demo), demo = (demo >= 100 ? 71 : demo + 16.7) }, 700);
}
...
mensaje.src = "images/caballo.mp3";
...
function selecciono(e){
    ...
    if(filap==filastar && columnap==columnastar){
        ...
        //abrir el enlace
        setTimeout(function() {location.href = "e6.html"}, 8000);
...
//dibujar filas 
function dibujarfilas(sombra, fila, columna, valor1, valor2, rev){
...
function sombrear(condi,fila, columna){
    ...
    //sombrar de arriba +1
    dibujarfilas(condi, fila, columna, 1, 1, false);
    ...
    //sombrear lo mismo pero al reves 
    //sombrear lo mismo pero al reves
    dibujarfilas(condi, columna, fila, 1, 1, true);
