...
var demo = lemonCount;
if(detener==false){
setInterval(function(){ updateProgress(demo), demo = (demo >= 100 ? 14.2 : demo + 14.2) }, 700);
}
...
function selecciono(e){
    ...
    if(filap==filastar && columnap==columnastar){
        ...
        //abrir el enlace
        setTimeout(function() {location.href = "e2.html"}, 8000);
        ...
        if(y!=columna){
           ...
           var elide=fila+'b'+y;
            ...
            if(sombra==true){
                ...
                but.style.cursor="";
                but.removeEventListener('click', selecciono);
            }
             ctx.fillStyle=rectcolor;
             ctx.fillRect(a1, a2, Cell_width, Cell_height);
